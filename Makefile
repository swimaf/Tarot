...
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun. déc. 5 21:40:07 2016
# Project:  tarot.pro
# Template: app
...
SOURCES       = src/main.cpp \
		...
		src/Defaut/Jeu.cpp \
		src/Fenetre/FenetreClassement.cpp moc_FenetreJeux.cpp \
		moc_Jeu.cpp \
