...
static const char qt_meta_stringdata_Jeu[] = {
    "Jeu\0\0lancer()\0"
};
...
const QMetaObjectExtraData Jeu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Jeu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Jeu,
      qt_meta_data_Jeu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Jeu::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Jeu))
